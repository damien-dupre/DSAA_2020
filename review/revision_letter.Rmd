...
> Indeed, artificial neural network techniques can quickly adjust to volatility changes, therefore incorporating sharp increases or decreases in their predictions [@aragones2007neural]. However, the model obtained from most artificial neural networks are hardly interpretable [@rudin2019stop].

The limitation of classic models applied to coastal areas is presented as follow:

> This problem is known as "finite area smoothing" and occurs when predictions from a model are approximated across geographical barriers, such as irregular coastal shapes, which would lead to poorly predicted values [@ramsay2002spline]. 
...
> The results of Irish 2016 census consultation is accessible through both the Central Statistics Office [@cso2020] and All-Island Research Observatory [@airo2020].
