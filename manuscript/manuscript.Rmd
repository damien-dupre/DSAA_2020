...
Because of the evolution of urban planning and the evolution of socio-economic features measured by the 2016 census, only properties sold in 2018 were processed to avoid potential temporal incoherence. The total amount of property sold in 2018 in the county Dublin which appears in the Property Price Register is `r n_raw`. From these, all property corresponding to apartments were removed (`r scales::percent(1-(n_house/n_raw), accuracy = 0.1)` of the original dataset). Finally, unsuccessfully geocoded properties were also removed from the original dataset (`r scales::percent(1-(n_final/n_house), accuracy = 0.1)`) to obtain the `r n_final` of the final dataset used to identify the urban and socio-economic correlates of property prices.
